...
impl Circuit {
    ...
    pub fn insert_gate(&mut self, gate_id: GateId, gate: Gate) {
        match gate {
            Gate::Nand(input_1, input_2) | Gate::And(input_1, input_2) | Gate::Xor(input_1, input_2) => {
                if !self.gates_bit_commitments_preimages.contains_key(&input_1) {
                    self.gates_bit_commitments_preimages.insert(input_1, BitCommitmentPreimages::new());
                }
                if !self.gates_bit_commitments_preimages.contains_key(&input_2) {
                    self.gates_bit_commitments_preimages.insert(input_2, BitCommitmentPreimages::new());
                }
            ...
            Gate::Inv(input) => {
                if !self.gates_bit_commitments_preimages.contains_key(&input) {
                    self.gates_bit_commitments_preimages.insert(input, BitCommitmentPreimages::new());
                }
        ...
        if !self.gates_bit_commitments_preimages.contains_key(&gate_id) {
            self.gates_bit_commitments_preimages.insert(gate_id, BitCommitmentPreimages::new());
        }
    ...
    pub fn collect_gates_bit_commitments_preimages<'a>(&'a self, gates_ids: &'a Vec<&'a GateId>) -> BTreeMap<&'a u64, &'a BitCommitmentPreimages> {
    ...
    pub fn collect_subsequent_gates_bit_commitments_preimages<'a>(&'a self, gates_ids: &'a Vec<&'a GateId>) -> BTreeMap<&'a u64, &'a BitCommitmentPreimages> {
        let mut collected = BTreeMap::new();
        for gate_id in gates_ids.into_iter() {
    ...
    pub fn compute_bit_commitments_hashes<'a>(&'a self, preimages: &'a BTreeMap<&'a u64, &'a BitCommitmentPreimages>) -> BTreeMap<u64, BitCommitmentHashes> {
